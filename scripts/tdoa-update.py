...
class KalmanCore:
    def __init__(self):
        ...
        self.P[KC_STATE_VX, KC_STATE_VX] = stdDevInitialVelocity**2
        self.P[KC_STATE_VY, KC_STATE_VY] = stdDevInitialVelocity**2
        self.P[KC_STATE_VZ, KC_STATE_VZ] = stdDevInitialVelocity**2
